...
public class RegisterFile {
	...
	public RegisterFile() {
		...
		for(int i = 0 ; i <32 ; i++) {
			// Initialize floating registers to 0..31 for visibility
			floating[i] = new Register(i, null);
			// Initialize integer registers similarly so the GUI shows R0..R31 values
			integer[i] = new Register(i, null);
